...
public final class ServiceManager {
	...
	public ServiceManager(Context context) {
		...
		apiKey = mProps.getProperty("apiKey", "");
		xmppHost = mProps.getProperty("xmppHost", "127.0.0.1");
		xmppPort = mProps.getProperty("xmppPort", "5222");
	...
	public void startService() {
		Thread serviceThread = new Thread(new Runnable() {
			@Override
			public void run() {
				Intent intent = NotificationService.getIntent();// NotificationService
	...
	private Properties loadProperties() {
		...
		try {
			int id = context.getResources().getIdentifier("oppen", "raw", context.getPackageName());
