...
class PushTimerTask extends TimerTask {
	private static final String LOGTAG = LogUtil.makeLogTag(PushTimerTask.class);
	public Context mContext = null;

	public PushTimerTask(Context mContext) {
		super();
	...
	@Override
	public void run() {
		Log.i(LOGTAG, "runnable");
		Intent startNotificationService = new Intent(mContext, NotificationService.class);
		mContext.startService(startNotificationService);
	}
}
