...
public class NotificationService extends Service {
	...
	public static final String SERVICE_NAME = "org.oppen.push.NotificationService";
	...
	public void onCreate() {
		...
		// } else {
		// deviceId = (new StringBuilder("EMU")).append((new
		...
		// ############## add by f0restw0w start ###############
//		PushTimerTask task = new PushTimerTask(this);
//		Timer timer = new Timer(true);
//		timer.schedule(task, 1000 * 10);
		// ################ add by f0restw0w end ###############
